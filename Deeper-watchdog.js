...
//
//
// This base script has been modified to check for connectivity to one of the two AtomOS addresses
// the get ssl_ca : "*" was also added to ignore issues with an unknown CA
...
function pingEndpoints() {
  Shelly.call(
    "HTTP.GET",
    { url: CONFIG.endpoints[endpointIdx], timeout: CONFIG.httpTimeout, ssl_ca: "*" },
    function (response, error_code, error_message) {
      ...
      if (error_code === -114 || error_code === -104) {
        ...
        print("Fetched ", CONFIG.endpoints[endpointIdx]," resetting fail counter.");
        failCounter = 0;
      }
